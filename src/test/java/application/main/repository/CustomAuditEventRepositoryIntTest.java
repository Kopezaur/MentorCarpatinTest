...
import application.main.config.audit.AuditEventConverter;
import application.main.domain.PersistentAuditEvent;
...
import static application.main.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
